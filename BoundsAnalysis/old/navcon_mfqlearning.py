...
import pickle
from new_mdp_description import NewMDPDescription, BoundType, MDPDescription
...
def simulate_mfq_learning(mdp: NewMDPDescription, T: int, eta1: float, eta2: float, eps: float, frequency_eval: int = 25, nav_constr: bool = False):
...
def simulate_soft_learning(mdp: NewMDPDescription, T: int, eta1: float, eta2: float, eta3: float, theta: float, frequency_eval: int = 25, nav_constr: bool = False):
    k = mdp.moment_order_k
    gamma = mdp.discount_factor
    ns, na = mdp.dim_state, mdp.dim_action
...
def simulate_q_learning(mdp: NewMDPDescription, T: int, eta: float, eps: float, frequency_eval: int = 25):
    gamma = mdp.discount_factor
    ns, na = mdp.dim_state, mdp.dim_action
